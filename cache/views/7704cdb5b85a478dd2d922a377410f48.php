                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e($customersCount ?? 0); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e($contactsCount ?? 0); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e($activeDealsCount ?? 0); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e(number_format($totalDealValue ?? 0, 0, ',', ' ')); ?> Kč</dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex-1 min-w-0">
                                        <p class="text-sm font-medium text-gray-900 truncate">
                                            <?php echo e($contact->getSubject()); ?>

                                        </p>
                                        <p class="text-sm text-gray-500">
                                            <?php echo e($contact->getCustomer()->getName()); ?> • <?php echo e($contact->getContactDate()->format('d.m.Y H:i')); ?>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="mt-4 flow-root">
                    <ul class="-my-5 divide-y divide-gray-200">
                        <?php if(isset($recentDeals) && count($recentDeals) > 0): ?>
                            ...
                            <li class="py-4">
                                <div class="flex items-center space-x-4">
                                    <div class="flex-1 min-w-0">
                                        <p class="text-sm font-medium text-gray-900 truncate">
                                            <?php echo e($deal->getTitle()); ?>

                                        </p>
                                        <p class="text-sm text-gray-500">
                                            <?php echo e($deal->getCustomer()->getName()); ?> • <?php echo e($deal->getValue() ? number_format($deal->getValue(), 0, ',', ' ') . ' Kč' : 'Bez hodnoty'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /custom/repositories/private/Arcadia/resources/views/reports/index.blade.php ENDPATH**/ ?>