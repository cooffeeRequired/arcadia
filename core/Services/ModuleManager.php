...
class ModuleManager
{
        ...
        foreach ($moduleDirs as $moduleDir) {
            ...
            if (file_exists($configFile)) {
                try {
                    ...
                    $modules[$moduleName] = $this->processModuleConfigOptimized($moduleName, $moduleConfig, $moduleDir, $moduleMap);
    ...
    private function processModuleConfigOptimized(string $moduleName, array $config, string $moduleDir, array &$moduleMap): Module
    {
        ...
        $this->processMigrationsOptimized($module, $config, $moduleDir);
    ...
    /**
     * Optimalizovaná verze zpracování migrací
     */
    private function processMigrationsOptimized(Module $module, array $config, string $moduleDir): void
    {
        $migrationsDir = $moduleDir . '/migrations';
    ...
    /**
     * Optimalizovaná verze zpracování jednotlivé migrace
     */
